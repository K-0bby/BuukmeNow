    ...
    <div className="flex flex-col xl:flex-row gap-10 items-center justify-center w-full">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-9">
          ...
          <h4 className="text-3xl w-full xl:text-5xl text-center px-2">
            Download our app now to <br /> get on-the-go access
          </h4>
        </div>
        <div className="relative flex flex-col lg:flex-row items-center justify-center gap-3 mt-8">
          <Link
            to="/"
            className="py-4 px-10 md:py-5 md:px-10 bg-[#fff] text-[#00100B] rounded-md text-xs md:text-base flex items-center gap-3"
          >
           <img src={Apple} alt="" />iOS App Coming Soom
          </Link>
          <Link
            to="/"
            className="py-4 px-8 md:py-5 md:px-6 bg-[#fff] text-[#00100B] rounded-md text-xs md:text-base flex items-center gap-3 "
          >
